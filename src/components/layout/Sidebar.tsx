...
const NAV = [
  { href: '/dashboard', icon: '🏠', label: 'Dashboard', roles: ['student','teacher','parent','admin'] },
  ...
  { href: '/dashboard/analytics', icon: '📊', label: 'Analytics', roles: ['student'] },
    ...
    <aside className="w-56 glass-sidebar flex flex-col">
      <div className="p-5 border-b border-gray-100/60">
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 bg-gradient-to-tr from-brand to-indigo-500 rounded-xl flex items-center justify-center shadow-md shadow-brand/15 group-hover:scale-105 transition-transform">
            <span className="text-white font-black text-sm">E</span>
          </div>
          <span className="font-extrabold text-gray-900 text-base tracking-tight">EduAI</span>
        </Link>
      </div>
